...
class AppTest {
    ...
    void testReversedSequence1() {
        String originalText = "ABCDEFG";
        ReversedSequence reversedText = new ReversedSequence(originalText);

        int expected = 7;
        int result = reversedText.length();
        assertThat(result).isEqualTo(expected);
    }
    ...
    void testReversedSequence3() {
        ...
        char expected = 'F';
        char result = reversedText.charAt(1);
        assertThat(result).isEqualTo(expected);
    }
    ...
    void testReversedSequence4() {
        ...
        String expected = "FEDC";
        String result = reversedText.subSequence(1, 5).toString();
        assertThat(result).isEqualTo(expected);
    }
