...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        Address address1 = new Address("Russia", "Saint Petersburg", "Lenina", "54", null);
        Map<String, List<String>> result1 = Validator.advancedValidate(address1);
        Map<String, List<String>> expected1 = Map.of();
        assertThat(result1).isEqualTo(expected1);

        Address address2 = new Address("A", "Saint Petersburg", "Lenina", "54", null);
        Map<String, List<String>> result2 = Validator.advancedValidate(address2);
        Map<String, List<String>> expected2= Map.of("country", List.of("length less than 3"));
        assertThat(result2).isEqualTo(expected2);

        Address address3 = new Address("Russia", "Tver", "Lenina", "54", null);
        Map<String, List<String>> result3 = Validator.advancedValidate(address3);
        Map<String, List<String>> expected3= Map.of("city", List.of("length less than 6"));
        assertThat(result3).isEqualTo(expected3);

        Address address4 = new Address("Russia", "Tver", null, "54", null);
        Map<String, List<String>> result4 = Validator.advancedValidate(address4);
        Map<String, List<String>> expected4= Map.of(
                "city", List.of("length less than 6"),
